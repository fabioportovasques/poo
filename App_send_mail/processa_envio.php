<?php
	...
	*/
	...
	try {
	    ...
	    //Recipients
	    $mail->setFrom('fabioportovasques321@gmail.com', 'App Send-Mail');
	    ...
	    $mensagem->status['descricao_status'] ='Não foi possível enviar o email . Detalhe do erro:' . $mail->ErrorInfo;
